...
//Remove @LoadBalanced in EmployeeConfig RestTemplate and Uncomment this endpoint and try
//    // Using RestTemplate and Eureka for Address Service Instance Discovery - Load Balancer Client
//    @GetMapping("/employeeWithEurekaAndLoadBalancerClient/{id}")
//    public ResponseEntity<EmployeeAddressResponseDto> getEmployeeWithAddressDetailsWithEurekaAndLBC(@PathVariable("id") int id)
//    {
//
//        EmployeeResponseDto employeeResponseDto = employeeService.getEmployeeDetails(id);
//
...
//        String uri = serviceInstance.getUri().toString();
//
//        System.out.println("LoadBalancedClient : uri >>>>>>>>>>>>>>>>> "+uri );
//        AddressDto addressDto = restTemplate.getForObject(
//                uri+"/address-app/api/address/{id}",
//                AddressDto.class,id
//        );
...
//    }
    ...
    // Using RestTemplate and Eureka for Address Service Instance Discovery - Load Balancer Client
    @GetMapping("/employeeWithEurekaAndLoadBalancerClientAnnotation/{id}")
    public ResponseEntity<EmployeeAddressResponseDto> getEmployeeWithAddressDetailsWithEureka(@PathVariable("id") int id)
    {
        ...
        // LoadBalanced - Automatically get me the details of Ip and Port number for Address Service
        System.out.println("http://ADDRESS-SERVICE/address-app/api/address/{id}");
        AddressDto addressDto = restTemplate.getForObject(
